Hi, I’m @derlico, a software engineer profficient in JavaScript (React, Vue, Next, Express Node), Java, Python, Machine Learning, Database (MySQL) and Cyber security 
